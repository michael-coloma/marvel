export enum PORTRAIT_SIZE_IMAGE {
  ...
  FANTASTIC_168X252 = "portrait_fantastic", // 168x252px
  UNCANNY_300X450 = "portrait_uncanny", // 300x450px
...
export enum STANDARD_SIZE_IMAGE {
  ...
  XLARGE_200X200 = "standard_xlarge", // 200x200px
  FANTASTIC_250X250 = "standard_fantastic", // 250x250px
...
export enum LANDSCAPE_SIZE_IMAGE {
  ...
  XLARGE_270X200 = "landscape_xlarge", // 270x200px
  AMAZING_250X156 = "landscape_amazing", // 250x156px
  INCREDIBLE_464X261 = "landscape_incredible", // 464x261px
}
